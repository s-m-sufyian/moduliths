...
class Types {
	...
	static class MoleculesTypes {
		...
		public static boolean isPresent() {
			return ClassUtils.isPresent(ENTITY_ANNOTATION, MoleculesTypes.class.getClassLoader());
		}

		public static boolean areRulesPresent() {
			return ClassUtils.isPresent(ARCHUNIT_RULES, MoleculesTypes.class.getClassLoader());
		}
	}
